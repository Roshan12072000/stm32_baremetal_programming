...
//Base address of ADC
#define ADC1_BASEADDR    0x50040000U
...
// DMA Register and channel defination
typedef struct
{
    volatile uint32_t ISR;
    volatile uint32_t IFCR;
} DMA_RegDef_t;
#define DMA1_CSELR (*(volatile uint32_t *)(DMA1_BASEADDR + 0xA8))
typedef struct
{
...
// DMA1 Channel Macro
#define DMA1_Channel1 ((DMA_Channel_RegDef_t *)(DMA1_BASEADDR + 0x08))

#define DMA1_Channel2 ((DMA_Channel_RegDef_t *)(DMA1_BASEADDR + 0x1C))

#define DMA1_Channel3 ((DMA_Channel_RegDef_t *)(DMA1_BASEADDR + 0x30))
#define DMA1_Channel4 ((DMA_Channel_RegDef_t *)(DMA1_BASEADDR + 0x44))
#define DMA1_Channel5 ((DMA_Channel_RegDef_t *)(DMA1_BASEADDR + 0x58))
#define DMA1_Channel6 ((DMA_Channel_RegDef_t *)(DMA1_BASEADDR + 0x6C))
#define DMA1_Channel7 ((DMA_Channel_RegDef_t *)(DMA1_BASEADDR + 0x80))
...
// Clock Enable Macros for DMA1 AND DMA2
#define DMA1_PCLK_EN()    (RCC->AHB1ENR |= (1 << 0))
#define DMA2_PCLK_EN()    (RCC->AHB1ENR |= (1 << 1))

// Clock Enable Macros for ADC1
#define ADC1_PCLK_EN()   (RCC->AHB2ENR |= (1 << 13))

// Clock Disable Macros for ADC1
#define ADC1_PCLK_DI()   (RCC->AHB2ENR &= ~(1 << 13))

// Clock Disable Macros for DMA1 AND DMA2
